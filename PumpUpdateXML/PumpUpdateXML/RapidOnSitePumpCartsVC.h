...
@class RapidOnSitePumpCart;

@interface RapidOnSitePumpCartsVC : UIViewController
@property (nonatomic, strong) NSString * cartID;
@end
@interface OnSitePumpCartCell : UITableViewCell
...
-(void)updateCellInformationFrom:(RapidOnSitePumpCart *)objFuelPump;
@end