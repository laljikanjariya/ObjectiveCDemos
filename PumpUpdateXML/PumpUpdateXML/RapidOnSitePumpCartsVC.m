...
@interface RapidOnSitePumpCartsVC ()<NSFetchedResultsControllerDelegate>
...
@implementation RapidOnSitePumpCartsVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    OnSitePumpCartCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    [cell updateCellInformationFrom:(RapidOnSitePumpCart *)[self.RMSPumpCartRC objectAtIndexPath:indexPath]];
    return cell;
}
...
- (NSFetchedResultsController *)RMSPumpCartRC {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"RapidOnSitePumpCart" inManagedObjectContext:self.managedObjectContext];
...
@implementation OnSitePumpCartCell
...
-(void)updateCellInformationFrom:(RapidOnSitePumpCart *)objPumpCart {
    ...
    self.lblBalanceAmount.text = [NSString stringWithFormat:@"Fuel Index : %d",objPumpCart.fuelIndex.integerValue];
    ...
    self.lblIsPaid.text = [NSString stringWithFormat:@"Pump Index : %@",objPumpCart.pumpIndex];
    self.lblPrice.text = [NSString stringWithFormat:@"Price : %.3f",objPumpCart.price.floatValue];
    self.lblRegInvNum.text = [NSString stringWithFormat:@"Volume : %@",objPumpCart.volume];
    self.lblTransactionType.text = [NSString stringWithFormat:@"Volume Limit : %@",objPumpCart.volumeLimit];
}
@end