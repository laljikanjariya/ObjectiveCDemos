...
- (instancetype)initWithRequest:(NSString*)strURL actionName:(NSString *)aName params:(NSDictionary*)params completionHandler:(CompletionHandler)completionHandler
{
    ...
    trustedHosts = [[NSArray alloc]initWithObjects:@"rapidrmseast-rapidrmsmodulewise.azurewebsites.net", nil];
...
- (void)URLSession:(NSURLSession *)session didReceiveChallenge:(NSURLAuthenticationChallenge *)challenge completionHandler:(void (^)(NSURLSessionAuthChallengeDisposition, NSURLCredential *))completionHandler{
    if([challenge.protectionSpace.authenticationMethod isEqualToString:NSURLAuthenticationMethodServerTrust]){
        if([challenge.protectionSpace.host isEqualToString:@"rapidrmseast-rapidrmsmodulewise.azurewebsites.net"]){
